<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mngseccess.aspx.cs" Inherits="mngseccess" %>
...
<body>
	...
	<div class="container">
        <p style="margin-left:80px;">修改成功，5秒内自动跳转到商家页面查看效果，若无法跳转请点击<asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/store.aspx">这里</asp:HyperLink>。</p>
    </div>
    </form>
</body>
</html>
