<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rgstseccess.aspx.cs" Inherits="rgstseccess" %>
...
<head id="Head1" runat="server">
    ...
    <meta http-equiv="refresh" content="3;url=manage.aspx" />
</head>
<body>
	...
	<div class="container">
        <p style="margin-left:80px;">注册成功，5秒内自动跳转到商家管理页面填写相关信息，若无法跳转请点击<asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/manage.aspx">这里</asp:HyperLink>。</p>
    </div>
    </form>
</body>
</html>
